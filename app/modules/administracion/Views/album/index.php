			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="album_nombre"
							value="<?php echo $this->getObjectVariable($this->filters, 'album_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>date</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="album_fecha"
							value="<?php echo $this->getObjectVariable($this->filters, 'album_fecha') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>image</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="album_imagen"
							value="<?php echo $this->getObjectVariable($this->filters, 'album_imagen') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="album_estado"
							value="<?php echo $this->getObjectVariable($this->filters, 'album_estado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
