<div class="caja-contenido-simple p-0 design-four four-<?php echo $contenido->contenido_id ?>"
	...
	<?php if ($contenido->contenido_enlace == 1) { ?>
		<a <?php if ($contenido->contenido_enlace_abrir == 1) { ?> target="_blank" <?php } ?>
	...
	<?php if ($contenido->contenido_enlace) { ?>
		...
		<a href="<?php echo $contenido->contenido_enlace; ?>" <?php if ($contenido->contenido_enlace_abrir == 1) { ?>
				target="_blank" <?php } ?> class="btn btn-block btn-vermas">
